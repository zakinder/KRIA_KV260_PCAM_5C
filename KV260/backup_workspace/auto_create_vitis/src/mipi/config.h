...
#define DEMO_MAX_FRAME (VIDEO_COLUMNS*VIDEO_ROWS*4) //(1920*1080*4)
#define DEMO_STRIDE (VIDEO_COLUMNS * 4)
#else
#define VIDEO_COLUMNS 1280
#define VIDEO_ROWS 720
#define DEMO_MAX_FRAME (VIDEO_COLUMNS*VIDEO_ROWS*3) //(1920*1080*4)
#define DEMO_STRIDE (VIDEO_COLUMNS * 3)
#endif
#define DEMO_MAX_FRAME (VIDEO_COLUMNS*VIDEO_ROWS)
