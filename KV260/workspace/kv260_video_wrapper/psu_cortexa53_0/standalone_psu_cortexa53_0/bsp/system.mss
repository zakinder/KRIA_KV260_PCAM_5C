...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = PS_VIDEO_RX_VIDEO_mipi_csi2_rx_subsyst_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = v_demosaic
 PARAMETER DRIVER_VER = 1.3
 PARAMETER HW_INSTANCE = PS_VIDEO_RX_VIDEO_v_demosaic_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = v_gamma_lut
 PARAMETER DRIVER_VER = 1.4
 PARAMETER HW_INSTANCE = PS_VIDEO_RX_VIDEO_v_gamma_lut_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = vfp
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = PS_VIDEO_RX_VIDEO_vfp_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = intc
 PARAMETER DRIVER_VER = 3.14
 PARAMETER HW_INSTANCE = PS_VIDEO_TO_PS_axi_intc_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = vtc
 PARAMETER DRIVER_VER = 8.4
 PARAMETER HW_INSTANCE = PS_VIDEO_VIDEO_PIPELINE_v_tc_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axivdma
 PARAMETER DRIVER_VER = 6.11
 PARAMETER HW_INSTANCE = PS_VIDEO_V_DMA_axi_vdma_0
END
